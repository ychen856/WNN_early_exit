...
if __name__ == "__main__":
    ...
    model.load_state_dict(torch.load("/Users/yi-chunchen/workspace/WNN_early_exit/model/wnn_unpruned.pth", map_location=device))
    ...
    for bit_rate in [1.0, 0.9, 0.8, 0.7, 0.6, 0.5, 0.4, 0.3]:
        for lut_rate in [1.0, 0.9, 0.8, 0.7, 0.6, 0.5, 0.4, 0.3]:
            ...
            export_wnn_for_fpga(model_pruned, f"/Users/yi-chunchen/workspace/WNN_early_exit/model/wnn_pruned_br{int(bit_rate*100)}_lr{int(lut_rate*100)}.npz", quant_bits=16)

            export_lut_init_files(
                f"/Users/yi-chunchen/workspace/WNN_early_exit/model/wnn_pruned_br{int(bit_rate*100)}_lr{int(lut_rate*100)}.npz",
                out_dir="/Users/yi-chunchen/workspace/WNN_early_exit/model/fpga_luts",
                fmt="mem",          # or "coe"
                radix=16,
            ...
            combo_dir = Path(f'/Users/yi-chunchen/workspace/WNN_early_exit/model/fpga_multilayer/br{int(bit_rate*100)}_lr{int(lut_rate*100)}')
