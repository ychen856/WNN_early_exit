...
if __name__ == "__main__":
    ...
    parser.add_argument("--use_augmentation", action="store_true",
                        help="Enable RandomCrop(28, padding=2) + RandomAffine(degrees=10, translate=(0.1, 0.1)) on train split")
    ...
    model = MultiLayerWNN(
        ...
        lut_tau_list=backbone_cfg['lut_tau_list'],     # Table 15: [0, 0.077, 0.165]
    ).to(device)
